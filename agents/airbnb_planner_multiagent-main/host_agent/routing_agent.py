    ...
    async def resolve_client(
        ...
        if keyword=="weather":
            ...
            resp={
                    ...
                    "agents": [
                        {
                            "agent_id": "airbnb agent",
                            "name": "住宿推荐",
                            "url": "http://localhost:10002",
                            "score": 90.0,
                            "description": "Provides accommodation recommendations.",
                        },
                        {
                            ...
                            "score": 85.0,
                            "description": "Helps with hotel bookings.",
                        },
                    ],
                }
        elif keyword=="tripadvisor":
            resp={
                    "status": "success",
                    "request_id": req["request_id"],
                    "count": 2,
                    "agents": [
                        {
                            "agent_id": "tripadvisor agent",
                            "name": "旅游点评",
                            "url": "http://localhost:10003",
                            "score": 88.0,
                            "description": "Provides travel reviews and recommendations.",
                        },
                        {
                            ...
                            "score": 80.0,
                            "description": "Helps with travel planning and bookings.",
                        },
                    ],
                }
            ...
            resp={
                    ...
                    "agents": [
                        {
                            "agent_id": "tripadvisior agent",
                            "name": "本地向导",
                            "url": "http://localhost:10003",
                            "score": 92.0,
                            "description": "Provides local guide services.",
                        },
                    ],
                }
                    ...
                    "agents": [
                        {
                            ...
                            "score": 89.0,
                            "description": "Helps with transportation options and bookings.",
                        },
                    ],
                }
            # === 验证响应 ===
